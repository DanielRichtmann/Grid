...
public:
  ...
  static constexpr int Ndiag     = Nred;
  static constexpr int Ntriangle = (Nred - 1) * Nc;
...
public:
  ...
  template<typename vtype> using iImplCloverDiagonal = iScalar<iVector<iVector<vtype,  6>, 2>>;
  template<typename vtype> using iImplCloverTriangle = iScalar<iVector<iVector<vtype, 15>, 2>>;
...
public:
    ...
    , DiagInvDagOdd(&Hgrid),  TriangleInvDagOdd(&Hgrid)
  {
    ...
    convertLayout(closure(adj(this->CloverTerm)), DiagDag, TriangleDag);
    convertLayout(this->CloverTermDagEven, DiagDagEven, TriangleDagEven);
    convertLayout(this->CloverTermDagOdd, DiagDagOdd, TriangleDagOdd);

    convertLayout(closure(adj(this->CloverTermInv)), DiagInvDag, TriangleInvDag);
    convertLayout(this->CloverTermInvDagEven, DiagInvDagEven, TriangleInvDagEven);
    convertLayout(this->CloverTermInvDagOdd, DiagInvDagOdd, TriangleInvDagOdd);
